...
myApp.factory('authService', ['$http', '$q', 'ngAuthSettings', 'localStorageService', '$cordovaDevice', function ($http, $q, ngAuthSettings, localStorageService, $cordovaDevice) {
    ...
    var _saveRegistration = function (registration) {
        ...
        return $http.post(serviceBase + '/api/auth/signup', registration).then(function (response) {
            return response;
        });
    ...
    var _checkEmail = function (email) {
        ...
        return $http.get(serviceBase + '/api/Employeeprofile/email/' + email).then(function (response) {
    ...
    var _login = function (loginData) {
        ...
        $http.post(serviceBase + '/api/auth/signin', loginData).success(function (response) {
